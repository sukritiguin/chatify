    ...
    <>
      <div className="flex justify-center items-center bg-gray-100">
        <div className="relative bg-white p-4 my-10 rounded-lg shadow-lg w-[75%] max-w-[1800px]">
          ...
          {/* Edit Icon */}
          <div className="absolute right-4 top-4 cursor-pointer mt-1 mr-1">
            <FaPen
          ...
          {/* Experience Section */}
          <ExperienceCard experience={profile.experiences} formatDateRange={formatDateRange} />

          <EducationCard educations={profile.educations} formatDateRange={formatDateRange}/>
s
